...
class Start_encryption_event : public Binary_log_event {
 public:
  static constexpr auto CRYPTO_SCHEME_LENGTH = 1;
  static constexpr auto KEY_VERSION_LENGTH = 4;
  static constexpr auto IV_LENGTH = 16; /* = MY_AES_BLOCK_SIZE */
  static constexpr auto IV_OFFS_LENGTH = 4;
  static constexpr auto NONCE_LENGTH = IV_LENGTH - IV_OFFS_LENGTH;
  static constexpr auto BINLOG_UUID_LENGTH = 36;
  ...
  char uuid[BINLOG_UUID_LENGTH + 1];
  ...
  size_t get_data_size_based_on_scheme();
