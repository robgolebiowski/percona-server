...
bool DDSE_dict_init(THD *thd, dict_init_mode_t dict_init_mode, uint version) {
  ...
  */
  ...
  dd::Properties *p = dd::Properties_impl::parse_properties(ddse_tablespaces.begin()->get_options());
...
bool initialize_dd_properties(THD *thd) {
  ...
  if (bootstrap::DD_bootstrap_ctx::instance().is_system_tablespace_encrypted()) {
