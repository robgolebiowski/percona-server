...
@return true if no algorithm requested */
  ...
  static bool none_explicitly_specified(
      ulong create_info_used_fields, const char *algorithm) noexcept MY_ATTRIBUTE((warn_unused_result));
  ...
  static bool should_be_keyring_encrypted(ulong create_info_used_fields, const char *algorithm)
      MY_ATTRIBUTE((warn_unused_result));
