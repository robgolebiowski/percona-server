...
fil_space_crypt_t *fil_space_read_crypt_data(const page_size_t &page_size,
  ...
  crypt_data->encryption_rotation =
      static_cast<Encryption::Encryption_rotation>(
...
void fil_space_crypt_t::write_page0(
  ...
  mach_write_to_1(encrypt_info_ptr,
                  static_cast<char>(current_encryption_rotation));
  encrypt_info_ptr += 1;
...
byte *fil_parse_write_crypt_data(space_id_t space_id, byte *ptr,
  ...
  crypt_data->encryption_rotation =
      static_cast<Encryption::Encryption_rotation>(mach_read_from_1(ptr));
  ptr += 1;
  uchar tablespace_key[ENCRYPTION_KEY_LEN];
...
static bool fil_crypt_start_encrypting_space(fil_space_t *space) {
  ...
  if (space->encryption_type == Encryption::AES) {  // We are re-encrypting
    ...
    crypt_data->encryption_rotation =
        Encryption::Encryption_rotation::MASTER_KEY_TO_KEYRING;
