...
void System_key_adapter::construct_system_key_data() noexcept {
  ...
  system_key_data.allocate(system_key_data_version_prefix.length() +
  ...
  memcpy(system_key_data.get_key_data(), system_key_data_version_prefix.c_str(),
         system_key_data_version_prefix.length());
  memcpy(
      system_key_data.get_key_data() + system_key_data_version_prefix.length(),
  ...
  keyring_key->set_key_data(system_key_data.get_key_data(),
                            system_key_data.get_key_data_size());
  keyring_key->xor_data();
...
uchar *System_key_adapter::System_key_data::get_key_data() { return key_data; }
